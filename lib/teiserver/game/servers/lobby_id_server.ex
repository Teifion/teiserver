defmodule Teiserver.LobbyIdServer do
  ...
  @spec get_next_lobby_id() :: {:error, :no_pid} | Teiserver.lobby_id()
  def get_next_lobby_id() do
    case get_server_pid() do
      nil -> {:error, :no_pid}
  ...
  @spec set_next_lobby_id(Teiserver.lobby_id()) :: :ok | {:error, :no_pid}
  def set_next_lobby_id(next_id) do
    case get_server_pid() do
      nil -> {:error, :no_pid}
